...
const Sidebar: React.FC = () => {
  ...
  const menuItems: MenuItem[] = [
    {
      id: 1,
      label: "Dashboard",
      icon: renderImage({ src: dashbord, alt: "Dashboard Icon", className: "w-5 h-5" }),
      path: "/dashboard",
    },
  ...
  return (
    <>
      ...
      <button
        className={`md:hidden fixed top-4 z-50 bg-blue-600 text-white p-2 rounded-md shadow-lg transition-all duration-300 ease-in-out 
